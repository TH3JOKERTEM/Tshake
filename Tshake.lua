...
local var = false
local hash =  'tshake:creator:'..chat_id
...
local hash =  'tshake:mods:'..chat_id
local mod = database:sismember(hash, user_id)
	local hashs =  'tshake:admins:'
local admin = database:sismember(hashs, user_id)
	local hashss =  'tshake:owners:'..chat_id
local owner = database:sismember(hashss, user_id)
	local hashss =  'tshake:creator:'..chat_id
local creator = database:sismember(hashss, user_id)
	local hashsss =  'tshake:vipgp:'..chat_id
...
local var = false
local hash =  'tshake:owners:'..chat_id
...
local var = false
	local hash = 'tshake:banned:'..chat_id
...
local var = false
	local hash = 'tshake:muted:'..chat_id
local banned = database:sismember(hash, user_id)
	 if banned then
	var = true
	 end
...
local function check_filter_words(msg, value)
  local hash = 'tshake:filters:'..msg.chat_id_
  if hash then
...
if tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  if database:get('tshake:lang:'..msg.chat_id_) then
...
if (data.result and data.result.can_promote_members or data.result.status == 'creator') then
    ...
    database:sadd('tshake:owners:'..msg.chat_id_,msg.sender_user_id_)
    end
    database:set("bot:enable:"..msg.chat_id_,true)
    if data.result.status == 'creator' then
    database:sadd('tshake:creator:'..msg.chat_id_, msg.sender_user_id_)
    end
    end
    else
   if database:get('tshake:lang:'..msg.chat_id_) then
...
local keko = database:get('tshake:setphoto'..msg.chat_id_..':'..msg.sender_user_id_)
if keko then
local id_keko = nil
...
database:del('tshake:setphoto'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
if msgs > (floodMax - 1) then
  ...
  local msgs = {[0] = id}
   ...
   local chat = msg.chat_id_
		...
		local bhash =  'tshake:banned:'..msg.chat_id_
...
if msgs > (floodMax - 1) then
  ...
  local msgs = {[0] = id}
   ...
   local chat = msg.chat_id_
		 del_all_msgs(msg.chat_id_, msg.sender_user_id_)
		user_id = msg.sender_user_id_
		local bhash =  'tshake:muted:'..msg.chat_id_
  database:sadd(bhash, user_id)
send(msg.chat_id_, msg.id_, 1, '🎫┇الايدي ~⪼*('..msg.sender_user_id_..')* \n❕┇قمت بعمل تكرار للرسائل المحدده\n☑┇وتم كتم من المجموعه\n', 1, 'md')
	  end
end
...
if database:get('tshake:muteall'..msg.chat_id_) and not is_vip(msg.sender_user_id_, msg.chat_id_) then
  local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if database:get('tshake:muteallwarn'..msg.chat_id_) and not is_vip(msg.sender_user_id_, msg.chat_id_) then
  local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if database:get('tshake:muteallban'..msg.chat_id_) and not is_vip(msg.sender_user_id_, msg.chat_id_) then
  local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if msg.content_.ID == "MessagePinMessage" then
  if database:get('pinnedmsg'..msg.chat_id_) and database:get('tshake:pin:mute'..msg.chat_id_) then
...
database:incr('user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
	database:incr('group:msgs'..msg.chat_id_)
if msg.content_.ID == "MessagePinMessage" then
  if database:get('pinnedmsg'..msg.chat_id_) and database:get('tshake:pin:warn'..msg.chat_id_) then
...
if database:get('tshake:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
		send(msg.chat_id_, msg.id_, 1, '❕┇قم بارسال المنشور من القناة️\n', 1, 'md')
		database:del('tshake:viewget'..msg.sender_user_id_)
	else
...
if msg_type == 'MSG:Photo' then
 if not is_vip(msg.sender_user_id_, msg.chat_id_) then
     if database:get('tshake:photo:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
        ...
        if msg.content_.caption_ then
          ...
          if database:get('tshake:links:mute'..msg.chat_id_) then
	if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") or msg.content_.caption_:match("@") or msg.content_.caption_:match("#") then
        ...
        if msg.forward_info_ then
          if database:get('tshake:forward:mute'..msg.chat_id_) then
       ...
       if database:get('tshake:photo:ban'..msg.chat_id_) then
           local id = msg.id_
           local msgs = {[0] = id}
           local chat = msg.chat_id_
           local user_id = msg.sender_user_id_
              delete_msg(chat,msgs)
               ...
               if database:get('tshake:photo:warn'..msg.chat_id_) then
                   local id = msg.id_
                   local msgs = {[0] = id}
                   local chat = msg.chat_id_
                   local user_id = msg.sender_user_id_
   ...
   if not is_vip(msg.sender_user_id_, msg.chat_id_) then
    if database:get('tshake:document:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
	...
	if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") or msg.content_.caption_:match("@") or msg.content_.caption_:match("#") then
        ...
        if database:get('tshake:document:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
       ...
       chat_kick(msg.chat_id_, msg.sender_user_id_)
        ...
        if database:get('tshake:document:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
...
elseif msg.content_.ID == 'MessageUnsupported' then
      if not is_vip(msg.sender_user_id_, msg.chat_id_) then
       if database:get('tshake:note:mute'..msg.chat_id_) then
       local id = msg.id_
       local msgs = {[0] = id}
       local chat = msg.chat_id_
          delete_msg(chat,msgs)
	...
	if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") or msg.content_.caption_:match("@") or msg.content_.caption_:match("#") then
           ...
           if database:get('tshake:note:ban'..msg.chat_id_) then
       local id = msg.id_
       local msgs = {[0] = id}
       local chat = msg.chat_id_
       local user_id = msg.sender_user_id_
          ...
          chat_kick(msg.chat_id_, msg.sender_user_id_)
           ...
           if database:get('tshake:note:warn'..msg.chat_id_) then
       local id = msg.id_
       local msgs = {[0] = id}
       local chat = msg.chat_id_
       local user_id = msg.sender_user_id_
  ...
  elseif msg_type == 'MSG:Inline' then
   if not is_vip(msg.sender_user_id_, msg.chat_id_) then
    if database:get('tshake:inline:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
        ...
        if database:get('tshake:inline:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
       ...
       chat_kick(msg.chat_id_, msg.sender_user_id_)
        ...
        if database:get('tshake:inline:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
  ...
  elseif msg_type == 'MSG:Sticker' then
   if not is_vip(msg.sender_user_id_, msg.chat_id_) then
  if database:get('tshake:sticker:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
        ...
        if database:get('tshake:sticker:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
       ...
       chat_kick(msg.chat_id_, msg.sender_user_id_)
        ...
        if database:get('tshake:sticker:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
...
elseif msg_type == 'MSG:NewUserLink' then
  if database:get('tshake:tgservice:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
...
if msg.content_.ID == "MessageChatAddMembers" then
      ...
      if database:get('tshake:bots:mute'..msg.chat_id_) and not is_mod(msg.content_.members_[0].id_, msg.chat_id_) then
chat_kick(msg.chat_id_,msg.content_.members_[0].id_)
   ...
   if is_banned(msg.content_.members_[0].id_, msg.chat_id_) then
       ...
       if msg.content_.ID == "MessageChatAddMembers" then
            if msg.content_.members_[0].type_.ID == 'UserTypeBot' then
      if database:get('tshake:bots:ban'..msg.chat_id_) and not is_mod(msg.content_.members_[0].id_, msg.chat_id_) then
		 chat_kick(msg.chat_id_, msg.content_.members_[0].id_)
		 chat_kick(msg.chat_id_, msg.sender_user_id_)
...
elseif msg_type == 'MSG:Contact' then
 if not is_vip(msg.sender_user_id_, msg.chat_id_) then
  if database:get('tshake:contact:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
        ...
        if database:get('tshake:contact:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
       ...
       chat_kick(msg.chat_id_, msg.sender_user_id_)
        ...
        if database:get('tshake:contact:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
...
elseif msg_type == 'MSG:Audio' then
 if not is_vip(msg.sender_user_id_, msg.chat_id_) then
  if database:get('tshake:music:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
	...
	if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") or msg.content_.caption_:match("@") or msg.content_.caption_:match("#") then
        ...
        if database:get('tshake:music:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
       ...
       chat_kick(msg.chat_id_, msg.sender_user_id_)
        ...
        if database:get('tshake:music:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
...
elseif msg_type == 'MSG:Voice' then
 if not is_vip(msg.sender_user_id_, msg.chat_id_) then
  if database:get('tshake:voice:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
	...
	if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") or msg.content_.caption_:match("@") or msg.content_.caption_:match("#") then
        ...
        if database:get('tshake:voice:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
       ...
       chat_kick(msg.chat_id_, msg.sender_user_id_)
        ...
        if database:get('tshake:voice:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
...
elseif msg_type == 'MSG:Location' then
 if not is_vip(msg.sender_user_id_, msg.chat_id_) then
  if database:get('tshake:location:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
        ...
        if database:get('tshake:location:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
       ...
       chat_kick(msg.chat_id_, msg.sender_user_id_)
        ...
        if database:get('tshake:location:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
...
elseif msg_type == 'MSG:Video' then
 if not is_vip(msg.sender_user_id_, msg.chat_id_) then
  if database:get('tshake:video:mute'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
	...
	if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") or msg.content_.caption_:match("@") or msg.content_.caption_:match("#") then
        ...
        if database:get('tshake:video:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
       ...
       chat_kick(msg.chat_id_, msg.sender_user_id_)
        ...
        if database:get('tshake:video:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
...
elseif msg_type == 'MSG:Gif' then
 if not is_vip(msg.sender_user_id_, msg.chat_id_) then
  if database:get('tshake:gifs:mute'..msg.chat_id_) and not is_vip(msg.sender_user_id_, msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
       delete_msg(chat,msgs)
	...
	if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") or msg.content_.caption_:match("@") or msg.content_.caption_:match("#") then
        ...
        if database:get('tshake:gifs:ban'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
     ...
     send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..")\n❕┇الصور المتحركه تم قفلها ممنوع ارسالها ️\n🚷┇تم طردك من المجموعه", 1, 'html')
        ...
        if database:get('tshake:gifs:warn'..msg.chat_id_) then
    local id = msg.id_
    local msgs = {[0] = id}
    local chat = msg.chat_id_
    local user_id = msg.sender_user_id_
...
if database:get('tshake:bots:mute'..msg.chat_id_) and not is_mod(result.id_, msg.chat_id_) then
		 return false
		 end
	  end
   end
...
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
 ...
 if database:get('tshake:links:ban'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  local user_id = msg.sender_user_id_
...
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..")\n❕┇الروابط تم قفلها ممنوع ارسالها ️\n🚷┇تم طردك من المجموعه", 1, 'html')
 ...
 if database:get('tshake:links:warn'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  local user_id = msg.sender_user_id_
...
if text then
  ...
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  local hash = 'tshake:sens:spam'..msg.chat_id_
  if not database:get(hash) then
sens = 500
  else
sens = tonumber(database:get(hash))
  end
  if database:get('tshake:spam:mute'..msg.chat_id_) and string.len(text) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
delete_msg(chat,msgs)
  end
end
...
if text then
  ...
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  local hash = 'tshake:sens:spam:warn'..msg.chat_id_
  if not database:get(hash) then
sens = 500
  else
sens = tonumber(database:get(hash))
  end
  if database:get('tshake:spam:warn'..msg.chat_id_) and string.len(text) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
delete_msg(chat,msgs)
  send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..")\n❕┇الكلايش تم قفلها ممنوع ارسالها", 1, 'html')
	...
	if text then
if database:get('tshake:text:mute'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
  ...
  if database:get('tshake:text:ban'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
  ...
  if database:get('tshake:text:warn'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.forward_info_ then
if database:get('tshake:forward:ban'..msg.chat_id_) then
	if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
...
if msg.forward_info_ then
if database:get('tshake:forward:warn'..msg.chat_id_) then
	if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
...
elseif msg_type == 'MSG:Text' then
   ...
   if database:get('tshake:tag:mute'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
  ...
  if database:get('tshake:tag:ban'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
  ...
  if database:get('tshake:tag:warn'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
   	...
   	if text:match("#") then
if database:get('tshake:hashtag:mute'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
  ...
  if database:get('tshake:hashtag:ban'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
  ...
  if database:get('tshake:hashtag:warn'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
   	...
   	if text:match("/") then
if database:get('tshake:cmd:mute'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if database:get('tshake:cmd:ban'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  local user_id = msg.sender_user_id_
...
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..")\n❕┇الشارحه تم قفلها ممنوع ارسالها ️\n🚷┇تم طردك من المجموعه", 1, 'html')
	...
	if database:get('tshake:cmd:warn'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  local user_id = msg.sender_user_id_
...
if database:get('tshake:webpage:mute'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
  ...
  if database:get('tshake:webpage:ban'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
  ...
  if database:get('tshake:webpage:warn'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if database:get('tshake:arabic:mute'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
  ...
  if database:get('tshake:arabic:ban'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
  ...
  if database:get('tshake:arabic:warn'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if database:get('tshake:english:mute'..msg.chat_id_) then
local id = msg.id_
  local msgs = {[0] = id}
  local chat = msg.chat_id_
  delete_msg(chat,msgs)
...
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
  ...
  delete_msg(chat,msgs)
	...
	if database:get('tshake:english:ban'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
  ...
  if database:get('tshake:english:warn'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
return
  ...
  if database:get('tshake:cmds'..msg.chat_id_) and not is_vip(msg.sender_user_id_, msg.chat_id_) then
  return
else
...
if text == 'هلو' then
if not database:get('tshake:rep:mute'..msg.chat_id_) then
...
if not database:get('tshake:leave:groups') then
...
if database:get('tshake:markdown:mute'..msg.chat_id_) then
if not is_vip(msg.sender_user_id_, msg.chat_id_) then
...
if database:get('tshake:markdown:ban'..msg.chat_id_) then
if not is_vip(msg.sender_user_id_, msg.chat_id_) then
delete_msg(msg.chat_id_, {[0] = msg.id_})
chat_kick(msg.chat_id_, msg.sender_user_id_)
...
if database:get('tshake:markdown:warn'..msg.chat_id_) then
if not is_vip(msg.sender_user_id_, msg.chat_id_) then
delete_msg(msg.chat_id_, {[0] = msg.id_})
...
local text = msg.content_.text_:gsub('رفع ادمن','setmote')
	...
	local hash = 'tshake:mods:'..msg.chat_id_
  ...
  if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n☑┇تم رفعه ادمن', 1, 'md')
	...
	if result.id_ then
	  database:sadd('tshake:mods:'..msg.chat_id_, result.id_)
  if database:get('tshake:lang:'..msg.chat_id_) then
...
texts = '<code>User not found!</code>'
  ...
  texts = '✖┇خطاء'
	...
	local apmd = {string.match(text, "^([Ss][Ee][Tt][Mm][Oo][Tt][Ee]) (%d+)$")}
	  database:sadd('tshake:mods:'..msg.chat_id_, apmd[2])
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..apmd[2]..')*  \n☑┇ تم تنزيله من ادمنيه البوت️ ', 1, 'md')
  ...
  local text = msg.content_.text_:gsub('رفع عضو مميز','setvip')
	...
	function promote_by_reply(extra, result, success)
	local hash = 'tshake:vipgp:'..msg.chat_id_
	if database:sismember(hash, result.sender_user_id_) then
  if database:get('tshake:lang:'..msg.chat_id_) then
  ...
  if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n☑┇تم رفعه عضو مميز', 1, 'md')
	...
	function promote_by_username(extra, result, success)
	if result.id_ then
	  database:sadd('tshake:vipgp:'..msg.chat_id_, result.id_)
  if database:get('tshake:lang:'..msg.chat_id_) then
...
texts = '<code>User not found!</code>'
  ...
  texts = '✖┇خطاء️'
	...
	local apmd = {string.match(text, "^([Ss][Ee][Tt][Vv][Ii][Pp]) (%d+)$")}
	  database:sadd('tshake:vipgp:'..msg.chat_id_, apmd[2])
if database:get('tshake:lang:'..msg.chat_id_) then
...
local text = msg.content_.text_:gsub('حظر','Ban')
	...
	local hash = 'tshake:banned:'..msg.chat_id_
...
send(msg.chat_id_, msg.id_, 1, '❕┇لا تسطيع حظر \n🔘┇(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
	  ...
	  database:sadd('tshake:banned:'..msg.chat_id_, result.id_)
  if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '❕┇لا تسطيع حظر \n🔘┇(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
	  ...
	  database:sadd('tshake:banned:'..msg.chat_id_, apba[2])
...
send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n☑️┇بالفعل تم الغاء حظره من البوت\n', 1, 'md')
 ...
 if result.id_ then
   database:srem('tshake:banned:'..msg.chat_id_, result.id_)
  if database:get('tshake:lang:'..msg.chat_id_) then
...
texts = '<code>User not found!</code>'
 ...
 local apba = {string.match(text, "^([Uu][Nn][Bb][Aa][Nn]) (%d+)$")}
   database:srem('tshake:banned:'..msg.chat_id_, apba[2])
  if database:get('tshake:lang:'..msg.chat_id_) then
...
local text = msg.content_.text_:gsub('كتم','silent')
	...
	local hash = 'tshake:muted:'..msg.chat_id_
	if is_mod(result.sender_user_id_, result.chat_id_) then
  if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '*You Can,t [Kick/Ban] Moderators!!*', 1, 'md')
 else
...
send(msg.chat_id_, msg.id_, 1, '✖┇لا تسطيع كتم \n🔘┇(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
	  ...
	  database:sadd('tshake:muted:'..msg.chat_id_, result.id_)
  if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '✖┇لا تسطيع كتم \n🔘┇(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
	  ...
	  database:sadd('tshake:muted:'..msg.chat_id_, apsi[2])
  if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n🚫┇بالفعل تم الغاء كتمه من البوت️', 1, 'md')
  ...
  if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n🚫┇تم الغاء كتمه من البوت️', 1, 'md')
	...
	if result.id_ then
   database:srem('tshake:muted:'..msg.chat_id_, result.id_)
  if database:get('tshake:lang:'..msg.chat_id_) then
...
texts = '<code>User not found!</code>'
  ...
  texts = '✖┇خطاء'
	...
	local apsi = {string.match(text, "^([Uu][Nn][Ss][Ii][Ll][Ee][Nn][Tt]) (%d+)$")}
	  database:srem('tshake:muted:'..msg.chat_id_, apsi[2])
  if database:get('tshake:lang:'..msg.chat_id_) then
...
local text = msg.content_.text_:gsub('رفع مدير','setowner')
	...
	local hash = 'tshake:owners:'..msg.chat_id_
	if database:sismember(hash, result.sender_user_id_) then
  if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n☑┇بالفعل تم رفع مدير في البوت', 1, 'md')
  ...
  if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n☑┇تم رفع مدير في البوت', 1, 'md')
	...
	if result.id_ then
	  database:sadd('tshake:owners:'..msg.chat_id_, result.id_)
  if database:get('tshake:lang:'..msg.chat_id_) then
...
texts = '<code>User not found!</code>'
  ...
  texts = '✖┇خطاء'
	...
	local apow = {string.match(text, "^([Ss][Ee][Tt][Oo][Ww][Nn][Ee][Rr]) (%d+)$")}
	  database:sadd('tshake:owners:'..msg.chat_id_, apow[2])
  if database:get('tshake:lang:'..msg.chat_id_) then
...
local text = msg.content_.text_:gsub('رفع منشئ','set creator')
	...
	local hash = 'tshake:creator:'..msg.chat_id_
	if database:sismember(hash, result.sender_user_id_) then
  if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n☑┇بالفعل تم رفع منشئ في البوت', 1, 'md')
  ...
  if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '👤┇العضو ~⪼ *('..result.sender_user_id_..')* \n☑┇تم رفع منشئ في البوت', 1, 'md')
	...
	if result.id_ then
	  database:sadd('tshake:creator:'..msg.chat_id_, result.id_)
  if database:get('tshake:lang:'..msg.chat_id_) then
...
texts = '<code>User not found!</code>'
  ...
  texts = '✖┇خطاء'
	...
	local apow = {string.match(text, "^([Ss][Ee][Tt] [Cc][Rr][Ee][Aa][Tt][Oo][Rr]) (%d+)$")}
	  database:sadd('tshake:creator:'..msg.chat_id_, apow[2])
  if database:get('tshake:lang:'..msg.chat_id_) then
...
database:set('tshake:sens:spam'..msg.chat_id_,sensspam[2])
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:set('tshake:sens:spam:warn'..msg.chat_id_,sensspam[2])
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:hset('tshake:filters:'..msg.chat_id_, name, 'filtered')
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:hdel('tshake:filters:'..msg.chat_id_, rws[2])
if database:get('tshake:lang:'..msg.chat_id_) then
...
if not database:get('tshake:bc:groups') then
local gps = database:scard("bot:groups") or 0
local gpss = database:smembers("bot:groups") or 0
	for i=1, #gpss do
...
if database:get('tshake:lang:'..msg.chat_id_) then
 if not database:get('tshake:id:mute'..msg.chat_id_) then
...
local text = msg.content_.text_:gsub('قفل الكل بالثواني','lock all s')
	...
	local mutept = {string.match(text, "^[Ll][Oo][Cc][Kk] [Aa][Ll][Ll] [Ss] (%d+)$")}
		database:setex('tshake:muteall'..msg.chat_id_, tonumber(mutept[1]), true)
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:setex('tshake:muteall'..msg.chat_id_, num, true)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇بالفعل تم قفل البوتات"..lockban.." ", 1, 'md')
 ...
 if mutept[2] == "bots ban" or Tshake[2] == "البوتات بالطرد" then
  if not database:get('tshake:bots:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "_> Bots Has been_ *locked*", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑️️┇تم قفل البوتات بالطرد"..lockban.." ", 1, 'md')
end
database:set('tshake:bots:ban'..msg.chat_id_,true)
  else
if database:get('tshake:lang:'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "_> Bots is Already_ *locked*", 1, 'md')
else
...
if mutept[2] == "pin warn" and is_owner(msg.sender_user_id_, msg.chat_id_) or Tshake[2] == "التثبيت بالتحذير" and is_owner(msg.sender_user_id_, msg.chat_id_) then
  if not database:get('tshake:pin:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:set('tshake:pin:warn'..msg.chat_id_,true)
  else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "media" or Tshake[2] == "الوسائط" then
	  if not database:get('tshake:muteall'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:muteall'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "media warn" or Tshake[2] == "الوسائط بالتحذير" then
	  if not database:get('tshake:muteallwarn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:muteallwarn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "media ban" or Tshake[2] == "الوسائط بالطرد" then
	  if not database:get('tshake:muteallban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:muteallban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "text ban" or Tshake[2] == "الدردشه بالطرد" then
	  if not database:get('tshake:text:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:text:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "text warn" or Tshake[2] == "الدردشه بالتحذير" then
	  if not database:get('tshake:text:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> Text ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل كل الدردشه"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:text:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "inline" or Tshake[2] == "الانلاين" then
	  if not database:get('tshake:inline:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:inline:mute'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "inline ban" or Tshake[2] == "الانلاين بالطرد" then
	  if not database:get('tshake:inline:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:inline:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "inline warn" or Tshake[2] == "الانلاين بالتحذير" then
	  if not database:get('tshake:inline:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> inline ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇ تم قفل كل الانلاين"..lockban.." ", 1, 'md')
end
   database:set('tshake:inline:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "video note" or Tshake[2] == "بصمه الفيديو" then
	  if not database:get('tshake:note:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:note:mute'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "video note ban" or Tshake[2] == "بصمه الفيديو بالطرد" then
	  if not database:get('tshake:note:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:note:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "video note warn" or Tshake[2] == "بصمه الفيديو بالتحذير" then
	  if not database:get('tshake:note:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> video note ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇ تم قفل بصمه الفيديو"..lockban.." ", 1, 'md')
end
   database:set('tshake:note:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "photo warn" or Tshake[2] == "الصور بالتحذير" then
	  if not database:get('tshake:photo:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> photo ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الصور"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:photo:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "video ban" or Tshake[2] == "الفيديو بالطرد" then
	  if not database:get('tshake:video:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:video:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "video warn" or Tshake[2] == "الفيديو بالتحذير" then
	  if not database:get('tshake:video:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> video ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الفيديو"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:video:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "gif ban" or Tshake[2] == "المتحركه بالطرد" then
	  if not database:get('tshake:gifs:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:gifs:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "gif warn" or Tshake[2] == "المتحركه بالتحذير" then
	  if not database:get('tshake:gifs:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> gifs ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل المتحركه"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:gifs:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "music ban" or Tshake[2] == "الاغاني بالطرد" then
	  if not database:get('tshake:music:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:music:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "music warn" or Tshake[2] == "الاغاني بالتحذير" then
	  if not database:get('tshake:music:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> music ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الاغاني"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:music:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "voice warn" or Tshake[2] == "الصوت بالتحذير" then
	  if not database:get('tshake:voice:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> voice ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الصوت"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:voice:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "links ban" or Tshake[2] == "الروابط بالطرد" then
	  if not database:get('tshake:links:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:links:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "links warn" or Tshake[2] == "الروابط بالتحذير" then
	  if not database:get('tshake:links:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> links ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الروابط"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:links:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "location" or Tshake[2] == "الشبكات" then
	  if not database:get('tshake:location:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:location:mute'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "location ban" or Tshake[2] == "الشبكات بالطرد" then
	  if not database:get('tshake:location:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:location:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "location warn" or Tshake[2] == "الشبكات بالتحذير" then
	  if not database:get('tshake:location:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> location ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الشبكات"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:location:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "tag warn" or Tshake[2] == "المعرف بالتحذير" then
	  if not database:get('tshake:tag:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> tag ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل المعرف"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:tag:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "hashtag ban" or Tshake[2] == "التاك بالطرد" then
	  if not database:get('tshake:hashtag:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
  ...
  send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل التاك"..lockban.." ", 1, 'md')
   ...
   database:set('tshake:hashtag:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "hashtag warn" or Tshake[2] == "التاك بالتحذير" then
	  if not database:get('tshake:hashtag:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> hashtag ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل التاك"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:hashtag:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "contact ban" or Tshake[2] == "الجهات بالطرد" then
	  if not database:get('tshake:contact:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:contact:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "contact warn" or Tshake[2] == "الجهات بالتحذير" then
	  if not database:get('tshake:contact:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> contact ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الجهات"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:contact:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "webpage" or Tshake[2] == "المواقع" then
	  if not database:get('tshake:webpage:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:webpage:mute'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "webpage ban" or Tshake[2] == "المواقع بالطرد" then
	  if not database:get('tshake:webpage:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:webpage:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "webpage warn" or Tshake[2] == "المواقع بالتحذير" then
	  if not database:get('tshake:webpage:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> webpage ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل المواقع"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:webpage:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "arabic ban" or Tshake[2] == "العربيه بالطرد" then
	  if not database:get('tshake:arabic:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:arabic:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "arabic warn" or Tshake[2] == "العربيه بالتحذير" then
	  if not database:get('tshake:arabic:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> arabic ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل العربيه"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:arabic:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "english" or Tshake[2] == "الانكليزيه" then
	  if not database:get('tshake:english:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:english:mute'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:english:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "english warn" or Tshake[2] == "الانكليزيه بالتحذير" then
	  if not database:get('tshake:english:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> english ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الانكليزيه"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:english:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "spam warn" or Tshake[2] == "الكلايش بالتحذير" then
	  if not database:get('tshake:spam:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:spam:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "sticker" or Tshake[2] == "الملصقات" then
	  if not database:get('tshake:sticker:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:sticker:mute'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "sticker ban" or Tshake[2] == "الملصقات بالطرد" then
	  if not database:get('tshake:sticker:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:sticker:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "sticker warn" or Tshake[2] == "الملصقات بالتحذير" then
	  if not database:get('tshake:sticker:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> sticker ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الملصقات"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:sticker:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "file ban" or Tshake[2] == "الملفات بالطرد" then
	  if not database:get('tshake:document:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
  ...
  send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الملفات"..lockban.." ", 1, 'md')
   ...
   database:set('tshake:document:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "file warn" or Tshake[2] == "الملفات بالتحذير" then
	  if not database:get('tshake:document:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> file ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الملفات"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:document:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "markdown" or Tshake[2] == "الماركدون" then
	  if not database:get('tshake:markdown:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:markdown:mute'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "markdown ban" or Tshake[2] == "الماركدون بالطرد" then
	  if not database:get('tshake:markdown:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:markdown:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "markdown warn" or Tshake[2] == "الماركدون بالتحذير" then
	  if not database:get('tshake:markdown:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> markdown ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الماركدون"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:markdown:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  ...
	  if not database:get('tshake:tgservice:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:tgservice:mute'..msg.chat_id_,true)
 else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "fwd" or Tshake[2] == "التوجيه" then
	  if not database:get('tshake:forward:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:forward:mute'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "fwd ban" or Tshake[2] == "التوجيه بالطرد" then
	  if not database:get('tshake:forward:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:set('tshake:forward:ban'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "fwd warn" or Tshake[2] == "التوجيه بالتحذير" then
	  if not database:get('tshake:forward:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> forward ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل التوجيه"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:forward:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if mutept[2] == "cmd warn" or Tshake[2] == "الشارحه بالتحذير" then
	  if not database:get('tshake:cmd:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> cmd ban has been_ *Locked*', 1, 'md')
else
   send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم قفل الشارحه"..lockwarn.." ", 1, 'md')
end
   database:set('tshake:cmd:warn'..msg.chat_id_,true)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if unmutept[2] == "bots ban" or UNTshake[2] == "البوتات بالطرد" then
  if database:get('tshake:bots:ban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
  send(msg.chat_id_, msg.id_, 1, "_> Bots ban Has been_ *Unlocked*", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم فتح البوتات"..lockban.." ", 1, 'md')
end
database:del('tshake:bots:ban'..msg.chat_id_)
  else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if unmutept[2] == "pin warn" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNTshake[2] == "التثبيت بالتحذير" and is_owner(msg.sender_user_id_, msg.chat_id_) then
  if database:get('tshake:pin:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:del('tshake:pin:warn'..msg.chat_id_)
  else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if unmutept[2] == "media" or UNTshake[2] == "الوسائط" then
	  if database:get('tshake:muteall'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:muteall'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if unmutept[2] == "media warn" or UNTshake[2] == "الوسائط بالتحذير" then
	  if database:get('tshake:muteallwarn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:muteallwarn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if unmutept[2] == "media ban" or UNTshake[2] == "الوسائط بالطرد" then
	  if database:get('tshake:muteallban'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:muteallban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:text:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:text:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:text:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:note:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:note:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:note:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:inline:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:inline:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:inline:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:photo:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:photo:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:photo:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:video:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:video:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:video:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if unmutept[2] == "gif" or UNTshake[2] == "المتحركه" then
	  if database:get('tshake:gifs:mute'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:gifs:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:gifs:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:gifs:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:music:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:music:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:music:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:voice:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:voice:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:voice:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:links:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:links:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
  ...
  send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم فتح الروابط"..lockwarn.." ", 1, 'md')
   ...
   database:del('tshake:links:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:location:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:location:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:location:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:tag:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:tag:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:tag:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:hashtag:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:hashtag:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:hashtag:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:contact:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:contact:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:contact:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:webpage:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:webpage:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:webpage:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:arabic:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:arabic:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:arabic:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:english:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:english:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:english:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if unmutept[2] == "spam warn" or UNTshake[2] == "الكلايش بالتحذير" then
	  if database:get('tshake:spam:warn'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:spam:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
  ...
  send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇تم فتح الملصقات"..lockmute.." ", 1, 'md')
   ...
   database:del('tshake:sticker:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:sticker:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:sticker:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:document:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:document:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:document:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:markdown:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:markdown:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:markdown:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:tgservice:mute'..msg.chat_id_)
 else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:forward:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:forward:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:forward:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:cmd:mute'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:cmd:ban'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   database:del('tshake:cmd:warn'..msg.chat_id_)
else
if database:get('tshake:lang:'..msg.chat_id_) then
...
local text = msg.content_.text_:gsub('مسح','clean')
 ...
 if txt[2] == 'banlist' or txt[2] == 'Banlist' or txt[2] == 'المحظورين' then
	database:del('tshake:banned:'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح المحظورين  من البوت ️', 1, 'md')
 ...
 if txt[2] == 'creators' and is_sudo(msg) or txt[2] == 'creatorlist' and is_sudo(msg) or txt[2] == 'Creatorlist' and is_sudo(msg) or txt[2] == 'Creators' and is_sudo(msg) or txt[2] == 'المنشئين' and is_sudo(msg) then
	database:del('tshake:creator:'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح جميع البوتات', 1, 'md')
	...
	database:del('tshake:mods:'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح قائمه الادمنيه', 1, 'md')
	...
	database:del('tshake:vipgp:'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح قائمه الاعضاء المميزين', 1, 'md')
	...
	database:del('tshake:owners:'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح قائمه المدراء', 1, 'md')
	...
	database:del('tshake:rules'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح القوانين المحفوظه', 1, 'md')
	...
	database:del('tshake:group:link'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح الرابط المحفوظ', 1, 'md')
	...
	database:del('tshake:filters:'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح قائمه المنع', 1, 'md')
	...
	database:del('tshake:muted:'..msg.chat_id_)
if database:get('tshake:lang:'..msg.chat_id_) then
...
os.execute('wget https://raw.githubusercontent.com/TH3JOKERTEM/Tshake/master/Tshake.lua')
 return false end
...
if database:get('tshake:location:mute'..msg.chat_id_) then
  ...
  ------------
if not database:get('tshake:sens:spam'..msg.chat_id_) then
spam_c = 300
else
spam_c = database:get('tshake:sens:spam'..msg.chat_id_)
end

if not database:get('tshake:sens:spam:warn'..msg.chat_id_) then
spam_d = 300
else
spam_d = database:get('tshake:sens:spam:warn'..msg.chat_id_)
end
...
if database:get('tshake:rep:mute'..msg.chat_id_) then
	lock_rep = '`lock | 🔐`'
	else
	lock_rep = '`unlock | 🔓`'
	end
...
if database:get('tshake:spam:mute'..msg.chat_id_) then
 ...
 if database:get('tshake:repsudo:mute'..msg.chat_id_) then
   	lock_repsudo = '✔️┇'
   	else
   	lock_repsudo = '✖️┇'
   	end

 if database:get('tshake:repowner:mute'..msg.chat_id_) then
   	lock_repowner = '✔️┇'
   	else
   	lock_repowner = '✖️┇'
   	end

 if database:get('tshake:id:mute'..msg.chat_id_) then
   	lock_id = '✔️┇'
   	else
   	lock_id = '✖️┇'
   	end
...
if (text and text == 'enable kick me') and is_owner(msg.sender_user_id_, msg.chat_id_)  or (text and text == 'Enable kick me') and is_owner(msg.sender_user_id_, msg.chat_id_) or (text and text == 'تفعيل اطردني') and is_owner(msg.sender_user_id_, msg.chat_id_) then
   if not database:get('tshake:kickme:mute'..msg.chat_id_) then
   if database:get('tshake:lang:'..msg.chat_id_) then
 ...
 send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل امر اطردني', 1, 'md')
  database:del('tshake:kickme:mute'..msg.chat_id_)
 end
 end
 end
 if (text and text == 'disable kick me') and is_owner(msg.sender_user_id_, msg.chat_id_)  or (text and text == 'disable kick me') and is_owner(msg.sender_user_id_, msg.chat_id_) or (text and text == 'تعطيل اطردني') and is_owner(msg.sender_user_id_, msg.chat_id_) then
   if database:get('tshake:kickme:mute'..msg.chat_id_) then
   if database:get('tshake:lang:'..msg.chat_id_) then
 ...
 send(msg.chat_id_, msg.id_, 1, '☑┇تم تعطيل امر اطردني', 1, 'md')
   database:set('tshake:kickme:mute'..msg.chat_id_,true)
 end
 end
   end
...
redis:set('keko1'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'', 'msg')
  return false end
if text:match("^(.*)$") then
if not database:get('tshake:repowner:mute'..msg.chat_id_) then
...
redis:set('keko1'..msg.sender_user_id_..''..bot_id, 'msg')
  return false end
if text:match("^(.*)$") then
if not database:get('tshake:repsudo:mute'..msg.chat_id_) then
...
local text = msg.content_.text_:gsub('وضع قوانين','setrules')
	...
	database:set('tshake:rules'..msg.chat_id_, txt[2])
if database:get('tshake:lang:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, "✔┇تم وضع القوانين للمجموعه", 1, 'md')
	...
	local rules = database:get('tshake:rules'..msg.chat_id_)
	if rules then
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:set('tshake:setphoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
if database:get('tshake:lang:'..msg.chat_id_) then
...
local langs = {string.match(text, "^(.*) (.*)$")}
  ...
  if not database:get('tshake:lang:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم وضع اللغه العربيه للبوت في المجموعه', 1, 'md')
 database:del('tshake:lang:'..msg.chat_id_)
end
end
...
send(msg.chat_id_, msg.id_, 1, '> _Language Bot has been changed to_ *English* !', 1, 'md')
  database:set('tshake:lang:'..msg.chat_id_,true)
end
end
end
----------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل ردود البوت', 1, 'md')
 database:del('tshake:rep:mute'..msg.chat_id_)
end
end
end
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم تعطيل ردود البوت', 1, 'md')
  database:set('tshake:rep:mute'..msg.chat_id_,true)
end
end
  end
...
if not database:get('tshake:id:photo'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
...
if database:get('tshake:lang:'..msg.chat_id_) then
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل الايدي بالصوره', 1, 'md')
   database:del('tshake:id:photo'..msg.chat_id_)
  end
end
end
...
if database:get('tshake:id:photo'..msg.chat_id_) then
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:set('tshake:id:photo'..msg.chat_id_,true)
  end
end
end
...
if database:get('tshake:bc:groups') then
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:set('tshake:bc:groups',true)
  end
end
end
...
if database:get('tshake:lang:'..msg.chat_id_) then
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل مغادره البوت', 1, 'md')
   database:del('tshake:leave:groups'..msg.chat_id_)
  end
end
end
...
if database:get('tshake:leave:groups') then
if database:get('tshake:lang:'..msg.chat_id_) then
...
database:set('tshake:leave:groups'..msg.chat_id_,true)
  end
end
end
	-----------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل ردود المطور', 1, 'md')
 database:del('tshake:repsudo:mute'..msg.chat_id_)
end
end
end
...
send(msg.chat_id_, msg.id_, 1, 'تم تعطيل ردود المطور', 1, 'md')
  database:set('tshake:repsudo:mute'..msg.chat_id_,true)
end
end
  end
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل ردود المدير', 1, 'md')
 database:del('tshake:repowner:mute'..msg.chat_id_)
end
end
end
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم تعطيل ردود المدير', 1, 'md')
  database:set('tshake:repowner:mute'..msg.chat_id_,true)
end
end
  end
	-----------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل الايدي', 1, 'md')
 database:del('tshake:id:mute'..msg.chat_id_)
end
end
end
...
send(msg.chat_id_, msg.id_, 1, '☑┇تم تعطيل الايدي', 1, 'md')
  database:set('tshake:id:mute'..msg.chat_id_,true)
end
end
  end
	-----------------------------------------------------------------------------------------------
...
if database:get('tshake:lang:'..msg.chat_id_) then
  ...
  database:set('tshake:viewget'..msg.sender_user_id_,true)
if database:get('tshake:lang:'..msg.chat_id_) then
...
🔎┇<a href="https://github.com/TH3JOKERTEM/TshAkE">رابط Github Cli (الرقم)،⚜️ </a>

🔎┇<a href="https://github.com/TH3JOKERTEM/Tshake">رابط Github Api (التوكن)،⚜️ </a>
...
text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
   if database:get('tshake:links:mute'..result.chat_id_) then
...
text:match("[Tt].[Mm][Ee]") or text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or
text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
   if database:get('tshake:links:warn'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
send(msg.chat_id_, 0, 1, "🚫┇ممنوع عمل تعديل للروابط", 1, 'html')
  ...
  if not is_mod(result.sender_user_id_, result.chat_id_) then
   check_filter_words(result, text)
   	if text:match("[Hh][Tt][Tt][Pp][Ss]://") or text:match("[Hh][Tt][Tt][Pp]://") or text:match(".[Ii][Rr]") or text:match(".[Cc][Oo][Mm]") or text:match(".[Oo][Rr][Gg]") or text:match(".[Ii][Nn][Ff][Oo]") or text:match("[Ww][Ww][Ww].") or text:match(".[Tt][Kk]") then
   if database:get('tshake:webpage:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
	end

   if database:get('tshake:webpage:warn'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
send(msg.chat_id_, 0, 1, "🚫┇ممنوع عمل تعديل للمواقع", 1, 'html')
  ...
  if not is_mod(result.sender_user_id_, result.chat_id_) then
   check_filter_words(result, text)
   if text:match("@") then
   if database:get('tshake:tag:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
	end
	   if database:get('tshake:tag:warn'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
send(msg.chat_id_, 0, 1,  "🚫┇ممنوع عمل تعديل للمعرفات", 1, 'html')
  ...
  if not is_mod(result.sender_user_id_, result.chat_id_) then
   check_filter_words(result, text)
   	if text:match("#") then
   if database:get('tshake:hashtag:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
	end
	   if database:get('tshake:hashtag:warn'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
send(msg.chat_id_, 0, 1, "🚫┇ممنوع عمل تعديل للتاكات", 1, 'html')
  ...
  if not is_mod(result.sender_user_id_, result.chat_id_) then
   check_filter_words(result, text)
   	if text:match("/")  then
   if database:get('tshake:cmd:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
	end
	   if database:get('tshake:cmd:warn'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
send(msg.chat_id_, 0, 1, "🚫┇ممنوع عمل تعديل للشارحه", 1, 'html')
  ...
  if not is_mod(result.sender_user_id_, result.chat_id_) then
   check_filter_words(result, text)
   	if text:match("[\216-\219][\128-\191]") then
   if database:get('tshake:arabic:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
	end
	end
	   if database:get('tshake:arabic:warn'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
send(msg.chat_id_, 0, 1, "🚫┇ممنوع عمل تعديل  للغه العربيه", 1, 'html')
  ...
  if not is_mod(result.sender_user_id_, result.chat_id_) then
   check_filter_words(result, text)
   if text:match("[ASDFGHJKLQWERTYUIOPZXCVBNMasdfghjklqwertyuiopzxcvbnm]") then
   if database:get('tshake:english:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
	end
	   if database:get('tshake:english:warn'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
 delete_msg(msg.chat_id_,msgs)
