...
keko = keko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق سبارتا لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
info = '👤┇بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'SPIRTA')..')\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'..text
...
info = '👤┇العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'SPIRTA')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '👤┇العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'SPIRTA')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
local hash =  'tshake:'..bot_id..'gbanned:'
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'SPIRTA')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'tshake:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'SPIRTA')..')\n��┇تم الغاء حظره من المجموعات البوت'
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'SPIRTA')..')\n\n☑┇تم رفعة مطور في البوت'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'SPIRTA')..')\n☑┇تم رفعة منشئ  في البوت'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
info = '👤┇العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'SPIRTA')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
if text and text:match("^رفع صخل @(.*)$") then
local apmd = {string.match(text, "^(رفع صخل) @(.*)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
database:sadd('tshake:'..bot_id..'sakl:'..msg.chat_id_, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Spirta')..')\n☑┇تم رفعة صخل'
else
texts = '✖┇خطاء'
end
...
if text and text:match("^رفع صخل (%d+)$") then
local apmd = {string.match(text, "^(رفع صخل) (%d+)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
send(msg.chat_id_, msg.id_, 1, '✖┇لا تستطيع الرفع تم تعطيل الرفع من قبل المنشئين \n', 1, 'md')
return false end
database:sadd('tshake:'..bot_id..'sakl:'..msg.chat_id_, apmd[2])
tsX000(apmd[2],msg,"☑┇تم رفعة صخل")
return false
end
...
if text and text:match("^تنزيل صخل @(.*)$") then
local hash =  'tshake:'..bot_id..'sakl:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل صخل) @(.*)$")}
function demote_by_username(extra, result, success)
if result.id_ then
database:srem(hash, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Spirta')..')\n🔰┇تم تنزيله من الصخول'
...
if text and text:match("^تنزيل صخل (%d+)$") then
local hash =  'tshake:'..bot_id..'sakl:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل صخل) (%d+)$")}
database:srem(hash, apmd[2])
tsX000(apmd[2],msg,"🔰┇تم تنزيله من الصخول")
return false
end  
...
if text and text:match("^رفع ضلع @(.*)$") then
local apmd = {string.match(text, "^(رفع ضلع) @(.*)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
database:sadd('tshake:'..bot_id..'zain:'..msg.chat_id_, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Spirta')..')\n☑┇تم رفعة ضلع'
else
texts = '✖┇خطاء'
end
...
if text and text:match("^رفع ضلع (%d+)$") then
local apmd = {string.match(text, "^(رفع ضلع) (%d+)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
send(msg.chat_id_, msg.id_, 1, '✖┇لا تستطيع الرفع تم تعطيل الرفع من قبل المنشئين \n', 1, 'md')
return false end
database:sadd('tshake:'..bot_id..'zain:'..msg.chat_id_, apmd[2])
tsX000(apmd[2],msg,"☑┇تم رفعة ضلع")
return false
end
...
if text and text:match("^تنزيل ضلع @(.*)$") then
local hash =  'tshake:'..bot_id..'zain:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل ضلع) @(.*)$")}
function demote_by_username(extra, result, success)
if result.id_ then
database:srem(hash, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Spirta')..')\n🔰┇تم تنزيله من الضلوع'
...
if text and text:match("^تنزيل ضلع (%d+)$") then
local hash =  'tshake:'..bot_id..'zain:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل ضلع) (%d+)$")}
database:srem(hash, apmd[2])
tsX000(apmd[2],msg,"🔰┇تم تنزيله من الضلوع")
return false
end  
...
local apmd = {string.match(text, "^(رفع مطي) @(.*)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
database:sadd('tshake:'..bot_id..'donke:'..msg.chat_id_, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Spirta')..')\n☑┇تم رفعة مطي'
else
texts = '✖┇خطاء'
end
...
if text and text:match("^رفع مطي (%d+)$") then
local apmd = {string.match(text, "^(رفع مطي) (%d+)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
send(msg.chat_id_, msg.id_, 1, '✖┇لا تستطيع الرفع تم تعطيل الرفع من قبل المنشئين \n', 1, 'md')
return false end
database:sadd('tshake:'..bot_id..'donke:'..msg.chat_id_, apmd[2])
tsX000(apmd[2],msg,"☑┇تم رفعة مطي")
return false
end
...
local hash =  'tshake:'..bot_id..'donke:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل مطي) @(.*)$")}
function demote_by_username(extra, result, success)
if result.id_ then
database:srem(hash, result.id_)
...
if text and text:match("^تنزيل مطي (%d+)$") then
local hash =  'tshake:'..bot_id..'donke:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل مطي) (%d+)$")}
database:srem(hash, apmd[2])
tsX000(apmd[2],msg,"🔰┇تم تنزيله من المطايه")
return false
end  
...
if text and text:match("^رفع زاحف @(.*)$") then
local apmd = {string.match(text, "^(رفع زاحف) @(.*)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
database:sadd('tshake:'..bot_id..'zahf:'..msg.chat_id_, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Spirta')..')\n☑┇تم رفعة زاحف'
else
texts = '✖┇خطاء'
end
...
if text and text:match("^رفع زاحف (%d+)$") then
local apmd = {string.match(text, "^(رفع زاحف) (%d+)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
send(msg.chat_id_, msg.id_, 1, '✖┇لا تستطيع الرفع تم تعطيل الرفع من قبل المنشئين \n', 1, 'md')
return false end
database:sadd('tshake:'..bot_id..'zahf:'..msg.chat_id_, apmd[2])
tsX000(apmd[2],msg,"☑┇تم رفعة زاحف")
return false
end
...
if text and text:match("^تنزيل زاحف @(.*)$") then
local hash =  'tshake:'..bot_id..'zahf:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل زاحف) @(.*)$")}
function demote_by_username(extra, result, success)
if result.id_ then
database:srem(hash, result.id_)
...
if text and text:match("^تنزيل زاحف (%d+)$") then
local hash =  'tshake:'..bot_id..'zahf:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل زاحف) (%d+)$")}
database:srem(hash, apmd[2])
tsX000(apmd[2],msg,"🔰┇تم تنزيله من الزواحف")
return false
end  
...
if text and text:match("^رفع كلب وفي @(.*)$") then
local apmd = {string.match(text, "^(رفع كلب وفي) @(.*)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
database:sadd('tshake:'..bot_id..'doq:'..msg.chat_id_, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Spirta')..')\n☑┇تم رفعة كلب وفي'
else
texts = '✖┇خطاء'
end
...
if text and text:match("^رفع كلب وفي (%d+)$") then
local apmd = {string.match(text, "^(رفع كلب وفي) (%d+)$")}
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Spirta&user_id="..msg.sender_user_id_);
data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @Spirta ⚜️\n', 1, 'html')   
...
send(msg.chat_id_, msg.id_, 1, '✖┇لا تستطيع الرفع تم تعطيل الرفع من قبل المنشئين \n', 1, 'md')
return false end
database:sadd('tshake:'..bot_id..'doq:'..msg.chat_id_, apmd[2])
tsX000(apmd[2],msg,"☑┇تم رفعة كلب وفي")
return false
end
...
if text and text:match("^تنزيل كلب وفي @(.*)$") then
local hash =  'tshake:'..bot_id..'doq:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل كلب وفي) @(.*)$")}
function demote_by_username(extra, result, success)
if result.id_ then
database:srem(hash, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Spirta')..')\n🔰┇تم تنزيله من الكلاب'
...
if text and text:match("^تنزيل كلب وفي (%d+)$") then
local hash =  'tshake:'..bot_id..'doq:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل كلب وفي) (%d+)$")}
database:srem(hash, apmd[2])
tsX000(apmd[2],msg,"🔰┇تم تنزيله من الكلاب")
return false
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apba[2] or 'SPIRTA')..')\n☑┇تم حظره من المجموعه'
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apsi[2] or 'SPIRTA')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apki[2] or 'SPIRTA')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(res[2] or 'SPIRTA')..')\n☑️┇تم تقييده'
end
else
texts = '✖️┇خطاء'
end
